...
const UpdateRate = () => {
  ...
  return (
    <div className="flex justify-center w-full items-center h-screen">
      <div className="backdrop-blur-sm h-72 w-72 flex flex-col border-black shadow-black drop-shadow-2xl shadow-2xl  gap-8 items-center border-2 border-dashed rounded-2xl">
