...
const User = () => {
  ...
  const { data: getUser, isLoading: userLoading } = useQuery(
    ["name"],
    async () => {
  ...
  return (
    <div className="flex w-full min-h-screen justify-center items-center">
      <div className="flex flex-col w-[80%] max-h-[80%]">
        <div className="container  mx-auto overflow-auto p-4 rounded-3xl bg-white shadow-2xl drop-shadow-2xl shadow-black">
          <div className="border border-gray-400 p-4">
            ...
            <div className="border-t border-gray-400 pt-4 mt-4 flex">
              <p className="text-sm italic">Payment Date: {Payrolls.month}</p>
